 ...
 * status, message, 선택적 code를 사용해 응답합니다. code가 없으면 status로 역산합니다.
...
export class NotFoundError extends AppError {
  constructor(message = '요청한 데이터를 찾을 수 없습니다.', code?: string) {
...
export class ForbiddenError extends AppError {
  constructor(message = '접근 권한이 없습니다.', code?: string) {
...
export class ConflictError extends AppError {
  constructor(message = '이미 존재하는 데이터입니다.', code?: string) {
...
export class BadRequestError extends AppError {
  constructor(message = '잘못된 요청입니다.', code?: string) {
